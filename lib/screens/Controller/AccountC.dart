...
class AccountC extends GetxController{
  ...
  Future FollowToggle(String followMail) async{
    ...
    DocumentReference docRef = FirebaseFirestore.instance.collection('Users').doc(followMail);
    ...
    await FirebaseFirestore.instance.collection('Users').doc(followMail).update({
      'Followers' : followers
    });
